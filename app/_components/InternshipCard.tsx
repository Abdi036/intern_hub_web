...
export default function InternshipCard({ internship }: InternshipCardProps) {
  ...
  return (
    <div
      className={`border border-gray-600 rounded-lg shadow-sm bg-card text-gray-300 ${
      deadLinePassed ? "opacity-50 pointer-events-none" : ""
      }`}
    >
      {/* Header */}
      ...
      <button
        onClick={deadLinePassed ? undefined : handleApply}
